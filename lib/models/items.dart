enum Items { 
  ...
  auspiciousArmor(18, 'Auspicious Armour', 'A peculiar set of armor that can make a certain species of Pokémon evolve. Auspicious wishes live within it.', 0, 750, 2500, false),
  ...
  maliciousArmor(23, 'Malicious Armour', 'A peculiar set of armor that can make a certain species of Pokémon evolve. Malicious will lurks within it.', 0, 750, 2500, false),
  ...
  const Items(this.key, this.name, this.description, this._cost, this._sellCost, this._blackCost, this.holdable);
  final num key;
  final String name;
