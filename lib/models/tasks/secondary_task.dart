...
class SecondaryTask extends Task{

  final String primaryField;
  final String secondaryField;

  factory SecondaryTask(int difficulty) {
    return _generateTask(difficulty);
  }

  SecondaryTask.withFields({required super.total, required super.progress, required super.text, required super.isComplete, required super.difficulty, required super.type, required this.primaryField, required this.secondaryField}) : super.withFields();
  ...
  @override
  Task clone() {
    return SecondaryTask.withFields(total: total, progress: progress, text: text, isComplete: isComplete, difficulty: difficulty, type: type, primaryField: primaryField, secondaryField: secondaryField); 
  }
}

SecondaryTask _generateTask(int difficulty) {
  switch (difficulty) {
...
SecondaryTask _weight1() {
  Random random = Random();
  switch (random.nextInt(865)) {
    case >= 0 && < 70: return _genGenTask('Earn 1000 total exp.', 1000, 1, 'general', 'totalExpEarned');
    case >= 70 && < 130: return _genGenTask('Earn 1000 total coins', 1000, 1, 'general', 'totalCoinsEarned');
    ...
    case >= 835 && < 865: return _genGenTask('Earn 1000 coins from selling items in the shop', 1000, 1, 'shop', 'sellCoinsEarned');
    default: throw Exception();
  }
}

SecondaryTask _weight2() {
  Random random = Random();
  switch (random.nextInt(989)) {
    case >= 0 && < 70: return _genGenTask('Earn 3000 total exp.', 3000, 2, 'general', 'totalExpEarned');
    case >= 70 && < 130: return _genGenTask('Earn 3000 total coins', 3000, 2, 'general', 'totalCoinsEarned');
    ...
    case >= 851 && < 881: return _genGenTask('Earn 2500 coins from selling items in the shop', 2500, 2, 'shop', 'sellCoinsEarned');
...
SecondaryTask _weight3() {
  Random random = Random();
  switch (random.nextInt(999)) {
    case >= 0 && < 70: return _genGenTask('Earn 10000 total exp.', 10000, 3, 'general', 'totalExpEarned');
    case >= 70 && < 130: return _genGenTask('Earn 10000 total coins', 10000, 3, 'general', 'totalCoinsEarned');
    ...
    case >= 851 && < 881: return _genGenTask('Earn 7500 coins from selling items in the shop', 7500, 3, 'shop', 'sellCoinsEarned');
    case >= 881 && < 921:
      final int rng = random.nextInt(2) + 2;
...
SecondaryTask _weight4() {
  Random random = Random();
  switch (random.nextInt(999)) {
    case >= 0 && < 70: return _genGenTask('Earn 30000 total exp.', 30000, 4, 'general', 'totalExpEarned');
    case >= 70 && < 130: return _genGenTask('Earn 30000 total coins', 30000, 4, 'general', 'totalCoinsEarned');
    ...
    case >= 851 && < 881: return _genGenTask('Earn 20000 coins from selling items in the shop', 20000, 4, 'shop', 'sellCoinsEarned');
    case >= 881 && < 921:
      final int rng = random.nextInt(6) + 5;
...
SecondaryTask _weight5() {
  Random random = Random();
  switch (random.nextInt(999)) {
    case >= 0 && < 70: return _genGenTask('Earn 100000 total exp.', 100000, 5, 'general', 'totalExpEarned');
    case >= 70 && < 130: return _genGenTask('Earn 100000 total coins', 100000, 5, 'general', 'totalCoinsEarned');
    ...
    case >= 851 && < 881: return _genGenTask('Earn 50000 coins from selling items in the shop', 50000, 5, 'shop', 'sellCoinsEarned');
    case >= 881 && < 921: 
      final int rng = random.nextInt(9) + 17;
...
SecondaryTask _weight6() {
  Random random = Random();
  switch (random.nextInt(1000)) {
    case >= 0 && < 70: return _genGenTask('Earn 1000000 total exp.', 1000000, 6, 'general', 'totalExpEarned');
    case >= 70 && < 130: return _genGenTask('Earn 1000000 total coins', 1000000, 6, 'general', 'totalCoinsEarned');
    ...
    case >= 851 && < 881: return _genGenTask('Earn 100000 coins from selling items in the shop', 100000, 6, 'shop', 'sellCoinsEarned');
...
SecondaryTask _genGenTask(String text, int total, int difficulty, String type, String primaryField) {
  return SecondaryTask.withFields(total: total, progress: 0, text: text, isComplete: false, difficulty: difficulty, type: type, primaryField: primaryField, secondaryField: 'TODO'); // TODO:
}